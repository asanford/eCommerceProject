...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
  	<?php
		...
		<title>Bread Winners Client - Michael Ku</title>
	</head>
	<body>
		<div id = "header">
		...
		<div class = "container_12">
			<div class = "grid_12">
				...
				<div class = "text">
					...
					<h3>Welcome Back, Michael Ku!</h3>
					
					<div class = "box">
						<h4>My Account</h4>
						<ul>
							<li><a href = "#">Change Personal Information</a></li>
							<li><a href = "#">Manage Shipping Addresses</a></li>
							<li><a href = "#">Change Billing Information</a></li>
							<li><a href = "#">Change Password</a></li>
							<li><a href = "#">Change Privacy Settings</a></li>
						</ul>
					</div>
